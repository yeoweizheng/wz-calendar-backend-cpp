...
void initDB() {
    ...
    *db << "CREATE TABLE IF NOT EXISTS scheduleitem (\"id\" integer NOT NULL PRIMARY KEY AUTOINCREMENT, \"name\" varchar(512) NOT NULL, \"date\" date NOT NULL, \"time\" time NULL, \"notes\" text NULL, \"user_id\" integer NOT NULL REFERENCES \"user\" (\"id\") DEFERRABLE INITIALLY DEFERRED, \"done\" bool NOT NULL, \"tag_id\" bigint NULL REFERENCES \"tag\" (\"id\") DEFERRABLE INITIALLY DEFERRED);";
